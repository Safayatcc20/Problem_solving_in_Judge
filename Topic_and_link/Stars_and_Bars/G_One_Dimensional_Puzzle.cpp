...
void solve(){
    ...
    // 3241
    // 4132
    // 13333333333332444444413333
    // 24444444444441333333324444
    ...
    int ans = 0;
    if(a == b){
        ans += nCr(a + c - 1 , a-1) * nCr(b+d , b) %mod;//start with 1
        ans += nCr(a + c , a) * nCr(b+d-1 , b-1) %mod;// start with 2
    }
    else if(a > b){
        ans += nCr(a + c - 1 , a-1) * nCr(b+d , b)%mod;// must start with 1
    }
    else{
        ans += nCr(a + c , a) * nCr(b+d-1 , b-1)%mod;// must start with 2
    }
    cout << ans %mod<< sad;
    /* 
    if(a == b){
        ans += nCr(a + c - 1 , c) * nCr(b+d , d) %mod;//start with 1
        ans += nCr(a + c , c) * nCr(b+d-1 , d) %mod;// start with 2
    }
    else if(a > b){
        ans += nCr(a + c - 1 , c) * nCr(b+d , d)%mod;// must start with 1
    }
    else{
        ans += nCr(a + c , c) * nCr(b+d-1 , d)%mod;// must start with 2
    }
    cout << ans %mod<< sad;
    */
}
