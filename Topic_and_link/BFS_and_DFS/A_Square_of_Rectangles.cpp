...
void solve(){
    ...
    if(l1 == l2 and l1 == l3 and b1+b2+b3 == l1){
    ...
    else if(b1 == b2 and b1 == b3 and l1+l2+l3 == b1){
        ha;
    }
    else{
        ...
        else if(l1 == l3 and b1 + b3 == b2 and l1 + l2 == b2){
            ha;
        }
        else if(l1 == l2 and b1 + b2 == b3 and l1 + l3 == b3){
            ha;
        }
        else if(b2 == b3 and l2 + l3 == l1 and b1 + b2 == l1){
            ha;
        }
        else if(b1 == b3 and l1 + l3 == l2 and l1 + l2 == l2){
            ha;
        }
        else if(b1 == b2 and l1 + l2 == l3 and l1 + l3 == l3){
            ha;
        }
        else na;
    }
